...
function Cad(){
    ...
    this.connect=function(callback){
	    var cad=this;		
	    //mongodb+srv://maria:admin@cluster0.qzsok.mongodb.net/impostormarlu?retryWrites=true&w=majority
		mongo.connect("mongodb+srv://maria:maria2021@cluster0.qzsok.mongodb.net/impostormarlu?retryWrites=true&w=majority",{useUnifiedTopology: true },function(err, database){
            if (err){
                console.log("No pudo conectar a la base de datos");
            }
            else{                
	 console.log("conectado a Mongo: colección partidas");                             
